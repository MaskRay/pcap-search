...
`./dshell-decode -d stream2dump --stream2dump_outfiles=out /mnt/ctf/DEF\ CON\ 22\ ctf\ teams/blue-lotus/blue-lotus_00100_20140808181530.cap`

`./offset2stream.py <file> <offset> {str|repr|hex|pcap} original.pcap outputfile`
